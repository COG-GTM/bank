...
public class CreateAccountCommand extends BaseCommand<String> {
    ...
    public CreateAccountCommand(String id, LocalDateTime commandDate, String commandBy, AccountStatus status, BigDecimal balance, Currency currency, String customerId) {
